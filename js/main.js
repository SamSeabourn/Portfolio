...
let width
let height
const changeColorMenu = document.getElementById('changeColorMenu')
...
function resizeSVG(){
    ...
    changeColorMenu
    // test.setAttribute("width", width)
    // test.setAttribute("height", height)
    // test.setAttribute("viewBox", `0 0 ${width} ${height}`)
